 ...
 * @ORM\Entity(repositoryClass="OC\PlateformeBundle\Repository\ApplicationRepository")
 */
class Application {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="OC\PlateformeBundle\Entity\Advert", inversedBy="applications")
